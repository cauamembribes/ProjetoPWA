manifest.json é um arquivo de configuração onde será armazenado os metadados da sua PWA, nesses metadados vai estar como a aplicação deve se apresentar e comportar.
